...
<head>
   ...
   function check_name(){
      if(document.joinform.username.value == "") alert("There's no input");
      else {
         window.open("check_name.do?id="+document.joinform.username.value,"","scrollbars=no,width=5,height=5,left=0,top=0");
         
         //document.joinForm.action = "check_name.do?id="+document.joinform.username.value;
         //document.redirect:check_name.do?id="+document.joinform.username.value
      }
   }
   </script>
</head>
...
<form name="joinform" method="post" action="join.do" >
   <h1>Sign up</h1>
      <p>
         ...
         <input id="inputusername" required="required" maxlength="30" size="20" name="username" required="required" type="text" placeholder="mysuperusername690" />
         <input type="button" onclick="javascript:check_name()" id="double_chk" value="중복체크"/>
      </p>
      <p>
         <label>Your email</label>
         <input id="inputemail" required="required" maxlength="30" size="30" name="email" required="required" type="email" placeholder="mysupermail@mail.com" />
      </p>
      <p>
         <label>Your password </label>
         <input id="inputPW" required="required" maxlength="30" size="20" name="pw" required="required" type="password" placeholder="eg. 1234" />
      </p>
      <p>
         <label>Please confirm your password </label>
         <input id="inputPW_confirm" required="required" maxlength="30" size="20" name="pw_check" required="required" type="password" placeholder="eg. 1234" />
      </p>
...
<div id="register" class="animate form">
   <form name="join_form" method="post" action="joinProcess" >
      <h1>Sign up</h1>
         <p>
         <label for="usernamesignup" class="uname" data-icon="u">Your username</label>
         <input id="usernamesignup" maxlength="30" size="20" name="name" required="required" type="text"   placeholder="mysuperusername690" />
         <input type="button" onclick="chk_name()" id="name_chk" value="double check"/>
         </p>
         <p>
         <label for="emailsignup" class="youmail" data-icon="e">Your email</label>
         <input id="emailsignup" maxlength="30" size="30" name="id" required="required" type="email" placeholder="mysupermail@mail.com" />
         <input type="button" onclick="chk_id()" id="id_chk" value="double check"/>
         </p>
         <p>
         <label for="passwordsignup" class="youpasswd" data-icon="p">Your password </label>
         <input id="passwordsignup" maxlength="30" size="20"   name="pw" required="required" type="password" placeholder="eg. X8df!90EO" />
         </p>
         <p>
      ...
      <div id="join-demo">
         ...
         <div id="wrapper">
            <div id="login" class="animate form">
               <form name="login_form" method="post" action="loginProcess">
                  <h1>Log in</h1>
                  <p>
                     <label for="username" class="uname" data-icon="u"> Your
                        email </label> <input id="username" maxlength="30" size="30" name="id"
